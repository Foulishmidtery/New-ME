...
const { executeQuery } = require('../src/server/legacy-db/postgres');
const fs = require('fs');
...
const tax_bea_masuk = async (req, res) => {
    try {
        // Query menggunakan JOIN untuk menarik nama_kategori utuh dari tabel master_kategori
        const query = `
            SELECT 
                t.id, t.kode_kategori, m.nama_kategori, t.kode_kbli, 
